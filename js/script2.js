...
const arrayList =[
	{name:'测试1',condition:['基础','URI','等于'],action:"1",port:"3000",priority:"1"},
	{name:'测试2',condition:['基础','URI','不等于'],action:"2",port:"3001",priority:"2"},
	{name:'测试3',condition:['基础','HTTP-Method','等于'],action:"2",port:"3001",priority:"2"}
   ]
   ...
   node.innerHTML =``
	var nodeItem=''
				   arrayList.forEach(function (el, i) {
					nodeItem+=`
					<tr>
					<td><input type="checkbox" name="istem">
					</td>
					<td>${el.name}
					</td>
					<td>
						<p>${el.condition[0]+el.condition[1]+el.condition[2]}</p>
					</td>
					<td>${el.action}
					</td>
					<td>${el.port}
...
// 	td3.innerHTML=el.condition[0]+el.condition[1]+el.condition[2];
// 	td4.innerHTML=el.action;
// 	td6.innerHTML=el.port;
// 	td5.innerHTML=el.priority;
// 	//操作添加
// 	//创建一个input节点
// var input2=document.createElement("input");
// 	input2.setAttribute('type','checkbox');
